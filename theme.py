...
class CustomTheme(Soft):
    ...
    def __init__(self):
        ...
        super().set(
            ...
            block_background_fill_dark="#F2F2F2", #bg color behind the input area
            ...
            input_background_fill_dark=light_grey_bg, #input alanı!!
            ...
            button_secondary_background_fill_hover_dark = "#000000", # I MADE THIS PINK
